...
public class OSGiVersion implements Comparable<OSGiVersion> {
	 ...
	 */
	public static final OSGiVersion emptyVersion = new OSGiVersion(0, 0, 0);
	 ...
	 */
	public OSGiVersion(int major, int minor, int micro) {
	 ...
	 *             string is invalid.
	 */
	public OSGiVersion(int major, int minor, int micro, String qualifier) {
		if (qualifier == null) {
			qualifier = ""; //$NON-NLS-1$
		}
	 ...
	 *             If <code>version</code> is improperly formatted.
	 */
	public static OSGiVersion parseVersion(String version) {
		if (version == null) {
			return emptyVersion;
		}
