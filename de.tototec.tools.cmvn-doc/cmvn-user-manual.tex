...
\code{-include} & FILE & Include the content of the given file \\
\code{-val} & OPTION & Create an immutable variable \emph{key} with content \emph{value} 
\end{tabular}
...
\begin{tabular}{llp{.7\textwidth}}
\textbf{Option} & \textbf{Format} & \textbf{Desciption} \\
