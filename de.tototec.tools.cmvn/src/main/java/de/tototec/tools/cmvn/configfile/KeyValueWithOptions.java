...
public class KeyValueWithOptions extends KeyValue {
	...
	public KeyValueWithOptions(final String key, final String value,
		...
		final String[] split = value.split(optionSeparator);
		if (split.length > 1) {
			for (int i = 1; i < split.length; ++i) {
				final String option[] = split[i].split(keyValueSeparator, 2);
	...
	public KeyValueWithOptions(final KeyValue keyValue, final String optionSeparator,
