...
class FetchCmd extends HelpAwareCmd {
  ...
  @CmdOption(names = Array("--jackage-fetch-cmd"), args = Array("CMD"), description = "Command to execute to fetch with Jackage. Use {MVN} as placeholder for the path to the local Maven repository and {PACK} as placeholder of the package.")
